\section{Resultados}
    ...
    en cada imagen del dataset propuesto junto con la justificación de las 
    decisiones tomadas.
    ...
    \subsection{Imagen 1}
        ...
        \begin{figure}[H]
            \centering
            \includegraphics[width=0.8\textwidth]{../results/describe_imagen1.jpg}
        ...
        1.4) hace que la imagen tienda a volverse blanca.
        ...
        corrección gamma. Por lo que ambas técnicas logran los resultados esperados sin 
        tener que realizar una búsqueda exhaustiva de los valores en las transformaciones.

        % \begin{figure}[H]
            % \centering
            % \includegraphics[width=0.9\textwidth]{../results/gain_bias_imagen1.jpg}
    ...
    \subsection{Imagen 2}
        ...
        la imagen, esto sugiere que el problema subyacente es el brillo mismo.\\

        \begin{figure}[h]
            \centering
            \includegraphics[width=0.8\textwidth]{../results/describe_imagen2.jpg}
            \caption{Descripción visual de la Imagen 2 en la que se puede observar un problema de brillo alto.}
        \end{figure}       
        ...
        Como se mencionó, la transformación gain-bias logra los resultados, en el 
        ...
        que ajustar esa sobreexposición con un sesgo conveniente. 

        \begin{figure}[H]
            \centering
            \includegraphics[width=0.9\textwidth]{../results/gain_bias_imagen2.jpg}
    ...
    \subsection{Imagen 3}
        ...
        \begin{figure}[H]
            \centering
            \includegraphics[width=0.8\textwidth]{../results/describe_imagen3.jpg}
        ...
        % \begin{figure}[H]
            % \centering
            % \includegraphics[width=0.9\textwidth]{../results/gain_bias_imagen3.jpg}
            % \caption{Transformación gain-bias de la Imagen 2 con un sesgo negativo hace posible bajar la iluminación de la imagen y mejorar ligeramente el contraste de la imagen final.}
        % \end{figure}
    ...
    \subsection{Imagen 4}
        ...
        \begin{figure}[h]
            \centering
            \includegraphics[width=0.8\textwidth]{../results/describe_imagen4.jpg}
        ...
        demasiado, esto por tener histogramas bien ecualizados, ocasionando que demasiados 
        valores se muevan a los extremos de intensidad.\\
        ...
        \begin{figure}[H]
            \centering
            \includegraphics[width=0.9\textwidth]{../results/gain_bias_imagen4.jpg}
    ...
    \subsection{Imagen 5}
        ...
        \begin{figure}[H]
            \centering
            \includegraphics[width=0.8\textwidth]{../results/describe_imagen5.jpg}
        ...
        logran efectos positivos sobre la imagen. 

        % \begin{figure}[H]
            % \centering
            % \includegraphics[width=0.9\textwidth]{../results/gain_bias_imagen5.jpg}
